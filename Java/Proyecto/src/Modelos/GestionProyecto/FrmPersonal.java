...
public class FrmPersonal extends FrmGenerica {
    private GestorVistaPersonal gestorVista;
    private int YES_NO_OPTION;
    Object getTxtRazon;

    public GestorVistaPersonal getGestorVista() {
        return gestorVista;
    }
    
    public void setGestorVista(GestorVistaPersonal gestorVista) {
...
// Constructores del formulario 
    public FrmPersonal(GestorVistaPersonal gestorVista) {
        try{
           initComponents();
           }
        catch(Exception e){
   ...
   @Override
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel8);
        jLabel8.setBounds(20, 290, 130, 20);
