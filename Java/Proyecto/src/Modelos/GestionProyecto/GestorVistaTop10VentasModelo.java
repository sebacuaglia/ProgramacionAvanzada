 ...
 * @author sebac
 */
public class GestorVistaTop10VentasModelo extends GestorVista {

    private FrmTop10VentasModelo form;
    private Venta model;
    private TableRowSorter sorter;

    public FrmTop10VentasModelo getForm() {
        return form;
    }

    public void setForm(FrmTop10VentasModelo form) {
        this.form = form;
    }
    ...
    public void openFormulario(JDesktopPane pantalla) {
        ...
        this.setForm(new FrmTop10VentasModelo(this));
    ...
    public List<Object[]> listar(String text, int ord, Date desde, Date hasta) {
        ...
        List<Object[]> lista = getSession().createNativeQuery("select mo.nombre,sum(d.precioAuto*d.cantidad) as monto,sum(d.cantidad) from detalleVenta d\n"
