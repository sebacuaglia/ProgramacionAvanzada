...
public class FrmTop10VentasMarca extends FrmGenerica {
    private GestorVistaTop10VentasMarca gestorVista;
    private int YES_NO_OPTION;

    public GestorVistaTop10VentasMarca getGestorVista() {
        return gestorVista;
    }
    
    public void setGestorVista(GestorVistaTop10VentasMarca gestorVista) {
...
// Constructores del formulario 
    public FrmTop10VentasMarca(GestorVistaTop10VentasMarca gestorVista) {
        try{
            initComponents();
        }
        catch(Exception e){
