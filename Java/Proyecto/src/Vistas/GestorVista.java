...
//    private Util util= new Util(); 
   ...
   public static final String pathReportes="./recursos/reportes/";
   public static final String PATH_BIEN="c:/recursos/reportes/";
  ...
  //// Metodos Model
    ...
    public void abrirListado(String archivo){
        try{
            ...
            gestorReportes.agregarParametro("tituloMembrete", "pROGRAMACION AVAZDA");
